...
bool AFSrealoc_common(vector<int> &tour, bool firstImprove, bool more_than_one){
    ...
    for(int j = 0; j < subtours.size(); j++){
        ...
        //double evals_tmp =problem->get_evals();
        auto st = subtours.at(j);
        ...
        //if(max_ev < (problem->get_evals() - evals_tmp)){
        //    max_ev =problem->get_evals() - evals_tmp;
        //}
    }
    ...
    //if(more_than_one){
    //    cout << "AFSrealoc more Evals used: " <<problem->get_evals() - evals_start << "  max: " << max_ev << endl;
    //}
    //else{
    //    cout << "AFSrealoc one Evals used: " <<problem->get_evals() - evals_start << "  max: " << max_ev  << endl;
    //}
